                ...
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            ...
                            <ul class="collapse" id="menu-tong-hop">
                                <li><a class="nav-link" href="#">TV / Màn hình</a></li>
                                <li><a class="nav-link" href="#">Điện thoại</a></li>
                                <li><a class="nav-link" href="#">Máy tính</a></li>
                                <li><a class="nav-link" href="#">Máy lạnh</a></li>
                                <li><a class="nav-link" href="#">Máy giặt</a></li>
                                <li><a class="nav-link" href="#">Đồ gia dụng</a></li>
                                <li><a class="nav-link" href="#">Linh kiện</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" wire:click.prevent="setActiveComponent('vanchuyen')">
                                <i class="fa-brands fa-codepen"></i> Quản lý đơn vị vận chuyển
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" wire:click.prevent="setActiveComponent('nhanvien')">
                                <i class="fas fa-users"></i> Quản lý nhân viên
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" wire:click.prevent="setActiveComponent('doitac')">
                                <i class="fas fa-handshake"></i> Quản lý Đối tác
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" wire:click.prevent="setActiveComponent('loaivattu')">
                                <i class="fa-brands fa-codepen"></i> Quản lý Loại vật tư
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" wire:click.prevent="setActiveComponent('donvitinh')">
                                <i class="fas fa-ruler-combined"></i> Quản lý đơn vị tính
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" wire:click.prevent="setActiveComponent('danhmuckho')">
                                <i class="fas fa-box"></i> Quản lý Danh Mục Kho
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" wire:click.prevent="setActiveComponent('vaitro')">
                                <i class="fas fa-tag"></i> Quản lý Vai Trò
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" wire:click.prevent="setActiveComponent('phongban')">
                                <i class="fa-brands fa-building"></i> Quản lý Phòng ban
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" wire:click.prevent="setActiveComponent('lenhDieuDong')">
