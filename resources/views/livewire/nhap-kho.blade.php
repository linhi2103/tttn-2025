                ...
                <tbody>
                    @foreach ($nhapkhos as $item)
                        <tr>
                            ...
                            <td>{{ $item->donvivanchuyen->PhuongTienVanChuyen ?? 'N/A' }}</td>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('MaDonViVanChuyen') is-invalid @enderror" 
                                    ...
                                    @foreach ($donvivanchuyen as $dvvc)
                                        <option value="{{ $dvvc->MaDonViVanChuyen }}">{{ $dvvc->MaDonViVanChuyen }}</option>
                                    @endforeach
                                </select>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" class="form-control @error('ChiTietNhapKho.'.$stt.'.SoLuongNhap') is-invalid @enderror" 
                                                            wire:model.live="ChiTietNhapKho.{{ $stt }}.SoLuongNhap" min="0" step="1" placeholder="0" required>
                                                    </td>
    ...
    <div class="modal fade show" style="display: block; background-color: rgba(0,0,0,0.5);"  tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Bạn có chắc chắn muốn xóa Phiếu Nhập Kho này không?</p>
                </div>
                <div class="modal-footer">
